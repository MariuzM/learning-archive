...
export default function Menu() {
  ...
  return (
    <nav css={navBar} className="animeNav">
      <ul className="nav__last-item">
        <Link className="nav-item" to="main" smooth duration={500}>
          <div className="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
              data-icon="old-republic"
              className="svg-inline--fa fa-old-republic fa-w-16"
              role="img"
        ...
        {/* <Link className="nav-item" to="about-me" smooth duration={500}>
          <div className="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
        ...
        <Link className="nav-item" to="projects" smooth duration={500}>
          <div className="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
        ...
        >
          <div className="nav-link">
            ...
            <span className="link-text">GitHub Projects</span>
          </div>
        </a>

        {/* <a
          className="nav-item"
          href="https://www.linkedin.com/in/marius-mariakinas/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="nav-link">
        ...
        <Link className="nav-item" to="contact-me" smooth duration={500}>
          <div className="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"

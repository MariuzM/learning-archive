export const SmallHut = () => {
  return (
    ...
    >
      ...
      <g id="_x33_">
        <path d="m7 18c-.552 0-1-.447-1-1v-6c0-.552.448-1 1-1s1 .448 1 1v6c0 .553-.448 1-1 1z" />
      </g>
      <g id="_x32_">
        <path d="m12 18c-.552 0-1-.447-1-1v-10c0-.552.448-1 1-1s1 .448 1 1v10c0 .553-.448 1-1 1z" />
      </g>
      <g id="_x31_">
        <path d="m17 18c-.553 0-1-.447-1-1v-6c0-.552.447-1 1-1s1 .448 1 1v6c0 .553-.447 1-1 1z" />
      </g>
    </svg>
  );
};
